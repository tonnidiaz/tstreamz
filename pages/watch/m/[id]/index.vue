            ...
            >
              <ul class="col-md-7 col-lg-6">
                <li>
                  <p>
                    ...
                    <span
                      ...
                      v-for="(it, i) in meta.credits.cast.slice(0, 5)"
                    >
                      <span
                        v-if="i !== meta.credits.cast.slice(0, 5).length - 1"
                        ><NuxtLink class="link" :to="`/discover/star/${it.id}`">
                          {{ it.name }}
                        </NuxtLink>
                        &nbsp; | &nbsp;</span
                      >
                ...
                <li>
                  <p>
                    <b>Genre(s): </b>
                    <span v-if="movie?.genres" v-for="(it, i) in movie?.genres">
                      <span v-if="i !== movie?.genres.length - 1"
                        ><NuxtLink class="link" :to="`/movies/genre/${it.id}`">
                          {{ it.name }}
                        </NuxtLink>
                        &nbsp; | &nbsp;</span
                      >
