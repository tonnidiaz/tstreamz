...
import "@repo/ui/styles/icons/@flaticon/flaticon-uicons/css/all/all.css"
...
import { importVideoAsyncThunk, playerStateActions } from "./redux/reducers/player";
...
function App() {
    ...
    const handleKeydown = (ev: KeyboardEvent) => { 
     ...
     const _importVideo = ()=>store.dispatch(importVideoAsyncThunk())
    useEffect(() => {
        try {
            // Setup shortcuts
            ...
            <TuTeleport to="#titlebar-slot">
                <div className="flex gap-4 items-center">
                    <TuDropdown trigger={<button>File</button>}>
                        <button onClick={_importVideo} className="tu-menu-item">
                            Import video
                        </button>
                        <TuDivider />
