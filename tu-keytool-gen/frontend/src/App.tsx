...
//     );
    ...
    const genKeystore = async () => {
        try {
            ...
            console.log({res});
            if (res == null) showToast("Keytool generated successfully!", "success")
            else showToast("Failed to generate keytool", "error")
        } catch (err) {
            handleErrs(err);
            showToast("Failed to generate keytool", "error")
        }
    };
    return (
        <div className="flex-col flex h-full w-full">
            ...
            <div className="tu-app flex-1" id="tu-app">
                <div className="p-4 w-full h-full flex-col gap-3 items-center justify-center oy-scroll">
                    <div className="my-4">
                        <h1 className="text-center fs-20 fw-6">Tu keytool generator</h1>
                    </div>
