...
const Page = ({
    ...
    return (
        <div className="p-4 w-full h-full" ref={pageRef}>
            <div className="h-full flex md:flex-row flex-col gap-2 justify-start items-center md:items-start md:justify-center w-full">
                <div className="bordered p-3 flex flex-col gap-2 w-350px max-h-100p oy-scroll">
            ...
            <div className="w-600px p-3 bordered rounded-md max-h-100p oy-scroll">
