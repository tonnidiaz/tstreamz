...
<script lang="ts">
    ...
    import { SITE, selectIntervals, selectPlatforms, selectSymbols, socket } from "@/lib/constants";
...
$effect(()=>{sessionStorage.setItem(`${location.pathname}__state`, JSON.stringify(formState))})
