            ...
            <div class="flex flex-col gap-3 font-monospace all">
                <div class="">
                    ...
                    <p class="flex justify-between mt-3">
                        <span class="fw-6 text-heading">ID:</span><span
                            >{order._id ?? order.id}</span
                        >
                    </p>
                    <p class="flex justify-between mt-3">
                        <span class="fw-6 text-heading">Profit:</span><span>
                            {order.profit}%</span
                        >
                    </p>
                </div>
                <div>
                    ...
                    <div class="flex justify-between ml-3">
                        <span class="text-heading fw-6">In:</span><span
                    ...
                    <div class="flex justify-between ml-3">
                        <span class="text-heading fw-6">Out:</span><span
                ...
                <div class="">
                    ...
                    <p class="flex justify-between">
                        <span class="fw-6 text-heading">Exit amount:</span><span
                            >{order.ccy} {order.new_ccy_amt}</span
                        >
                    </p>
                </div>
                <div class="my-1">
                ...
                <div class="my-1">
                    <p class="flex justify-between">
                        <span class="fw-6 text-heading">Entry price:</span><span
                            >{order.ccy}
                            {order.buy_price ?? "-- -- --"}</span
                        >
                    </p>
                    <p class="flex justify-between">
                        <span class="fw-6 text-heading">Exit price:</span><span
                            >{order.ccy}
                ...
                <p class="flex justify-between">
                    <span class="fw-6 text-heading">Base amount:</span><span
                        >{order.base} {order.base_amt}</span
                    >
                </p>
                <p class="flex justify-between">
                    <span class="fw-6 text-heading">Buy fee:</span><span
                        >{order.base} {order.buy_fee}</span
                    >
                </p>
                <p class="flex justify-between">
                    <span class="fw-6 text-heading">Sell fee:</span><span
                        >{order.ccy} {order.sell_fee}</span
                    >
                </p>
                <div class="my-2 hidden">
                    <UFormGroup label="Highs" class="text-white">
                        <TuJson
                            data={order.all_highs?.map((el) => ({
                                ts: el.ts,
                                val: el.val,
                                tp: el.tp,
                                px: el.px,
